...
function isStorageExist() {
   if (typeof Storage === "undefined") {
      swal("Maaf, Browser anda tidak mendukung web storage. Silahkan gunakan Browser yang lainnya", "info");
      return false;
   }
   return true;
}
...
function addBook() {
   ...
   saveData();
   swal("Berhasil", "Buku baru sudah ditambahkan ke rak");
}
...
function removeBook(bookId) {
   ...
   swal({
      ...
      if (willDelete) {
         ...
         swal("Berhasil", "Satu buku sudah dihapus dari rak");
      } else {
...
function resetRak() {
   swal({
      ...
      if (willDelete) {
         ...
         swal("Berhasil", "Semua buku sudah dihapus dari rak");
      } else {
   ...
   for (const index in books) {
      if (index === bookIndex) {
         if (books[index].isCompleted === true) {
            ...
            swal("Berhasil", "Buku sudah dipindahkan ke rak belum selesai dibaca");
         } else {
            books[index].isCompleted = true;
            swal("Berhasil", "Buku sudah dipindahkan ke rak selesai dibaca");
         }
      }
   }
...
function editBookData(bookId) {
   ...
   SubmitEdit.addEventListener("click", (e) => {
      ...
      swal("Berhasil", "Data buku sudah berhasil diedit");
   });
